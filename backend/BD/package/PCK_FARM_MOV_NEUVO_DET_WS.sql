CREATE OR REPLACE PACKAGE BODY "FARMACIACLINICA"."PCK_FARM_MOV_NEUVO_DET_WS" AS PROCEDURE pck_farm_mov_neuvo_det_ws /*  Registra Movimientos WS Fin700  */ (
