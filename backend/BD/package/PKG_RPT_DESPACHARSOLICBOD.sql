CREATE OR REPLACE PACKAGE BODY "FARMACIACLINICA"."PKG_RPT_DESPACHARSOLICBOD" As

Procedure PRO_RPT_DESPACHARSOLICBOD  
...
DECLARE
   v_dessoliprioridad       RPT_DESPACHARSOLICBOD.dessoliprioridad%type;
   v_fechacreacion          RPT_DESPACHARSOLICBOD.fechacreacion%type;
   v_estadosolicitudde      RPT_DESPACHARSOLICBOD.estadosolicitudde%type;
   v_bodorigendesc          RPT_DESPACHARSOLICBOD.bodorigendesc%type;
   v_boddestinodesc         RPT_DESPACHARSOLICBOD.boddestinodesc%type;
   v_bodorigen              number(3);
   v_boddestino             number(3);
   v_mfde_id                clin_far_movimdet.mfde_id%type;       
   v_lote                   clin_far_movimdet.mfde_lote%type;
   v_fechavto               RPT_DESPACHARSOLICBOD.fechavto%type;
...
BEGIN
   ...
   LOOP
      ...
      Begin
         Insert Into RPT_DESPACHARSOLICBOD
             (  idreport
                ,soliid
                ,dessoliprioridad 
                ,fechacreacion
...
End PRO_RPT_DESPACHARSOLICBOD;

End PKG_RPT_DESPACHARSOLICBOD;
/