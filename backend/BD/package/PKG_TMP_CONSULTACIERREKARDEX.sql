CREATE OR REPLACE PACKAGE BODY "FARMACIACLINICA"."PKG_TMP_CONSULTACIERREKARDEX" As

Procedure PRO_TMP_CONSULTACIERREKARDEX  
...
BEGIN
       ...
       --insert into PASO_ERRORES_EO(DESCRIPCION, FECHA ) values ('PKG_RPT_CONSULTACIERREKARDEX - ahora' , sysdate ); commit;
        ...
        --insert into PASO_ERRORES_EO(DESCRIPCION ) values ('PKG_RPT_CONSULTACIERREKARDEX - paso 1, v_CKAR_ID_CierreAnterior:' || v_CKAR_ID_CierreAnterior || In_HdgCodigo || In_CMECODIGO || In_CodBodega    ); commit;
        ...
        --insert into PASO_ERRORES_EO(DESCRIPCION, FECHA ) values ('PKG_RPT_CONSULTACIERREKARDEX - paso 2, v_CKAR_FECHA_APERTURA:' || v_CKAR_FECHA_APERTURA , sysdate ); commit;
...
End PRO_TMP_CONSULTACIERREKARDEX;

End PKG_TMP_CONSULTACIERREKARDEX;
/