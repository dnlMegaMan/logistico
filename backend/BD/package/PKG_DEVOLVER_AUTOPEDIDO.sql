create or replace PACKAGE PKG_DEVOLVER_AUTOPEDIDO as
    PROCEDURE P_DEVOLVER_AUTOPEDIDO(
...
END PKG_DEVOLVER_AUTOPEDIDO;
/
create or replace PACKAGE BODY PKG_DEVOLVER_AUTOPEDIDO AS
    ...
    PROCEDURE P_DEVOLVER_AUTOPEDIDO(
	 ...
	 BEGIN
	   ...
	   SELECT CLIN_IDAGRUPAMOVDEV_SEQ.NEXTVAL INTO IDAgrupadorMovDev from Dual;
        ...
        RESPONSE := 'Exito Al Devolver Autopedido';       
        OUT_RESPONSE := RESPONSE;

    END P_DEVOLVER_AUTOPEDIDO;
END PKG_DEVOLVER_AUTOPEDIDO;
/
