CREATE OR REPLACE PACKAGE PCK_FILTRO_GENERAR_AJUSTE_INVENTARIO AS

    PROCEDURE P_FILTRO_GENERAR_AJUSTE_INVENTARIO (
...
END PCK_FILTRO_GENERAR_AJUSTE_INVENTARIO;
/

CREATE OR REPLACE PACKAGE BODY PCK_FILTRO_GENERAR_AJUSTE_INVENTARIO AS
            ...
            FROM
                (
                    ...
                    WHERE
                        ...
                        AND INV.INVE_FECHA_APROBACION IS NOT NULL
                        AND ( INV.INVE_GENERA_AJUSTE = 'N'
                        OR INV.INVE_GENERA_AJUSTE IS NULL )
                );
        END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            SRV_MESSAGE := SQLERRM;
    END P_FILTRO_GENERAR_AJUSTE_INVENTARIO;
