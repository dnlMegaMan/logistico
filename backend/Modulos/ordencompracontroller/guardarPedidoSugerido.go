...
// GuardaPedidoSugerido is...
func GuardaPedidoSugerido(w http.ResponseWriter, r *http.Request) {
	...
	QUERY := "BEGIN PKG_PEDIDO_SUGERIDO.P_GUARDAR_PEDIDO_SUGERIDO(:1,:2); END;"
