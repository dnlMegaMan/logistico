...
// ObtieneURLinfDocumentosIngresados is...
func ObtieneURLinfDocumentosIngresados(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfDocumentosIngresados
	...
	res := models.ParamInfDocumentosIngresados{}
	...
	_, err = db.Exec("Begin PKG_RPT_DOCUM_INGRESADOS.PRO_RPT_DOCUM_INGRESADOS(:In_Fecha_Ini,:In_Fecha_Fin,:In_TipoMov,:In_TipoReg,:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo); end;", PFechaini, PFechafin, PTipoMov, PTipoReg, intIDReport, PHdgCodigo, PEsaCodigo, PCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_DOCUM_INGRESADOS.PRO_RPT_DOCUM_INGRESADOS",
			Error:   err,
			Contexto: map[string]interface{}{
				"PFechaini": PFechaini, "PFechafin": PFechafin, "PTipoMov": PTipoMov,
				"PTipoReg": PTipoReg, "intIDReport": intIDReport, "PHdgCodigo": PHdgCodigo,
	...
	sReporte = "logistico/rpt_docum_ingresados.rpt"
	sTipo = PTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe documentos ingresados",
		Contexto: map[string]interface{}{
