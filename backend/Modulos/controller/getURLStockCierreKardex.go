...
// GetURLStockCierreKardex is...
func GetURLStockCierreKardex(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamStockCierreKardex
	...
	res := models.ParamStockCierreKardex{}
	...
	qry = " BEGIN"
	qry = qry + " PKG_RPT_STOCKCIERREKADEX.PRO_RPT_STOCKCIERREKADEX("
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package reporte stock cierre kardex",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package reporte stock cierre kardex",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	...
	sReporte = "stockcierrekardex.rpt"
