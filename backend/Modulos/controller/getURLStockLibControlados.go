...
// GetURLStockLibControlados is...
func GetURLStockLibControlados(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamStockLibControlados
	...
	res := models.ParamStockLibControlados{}
	...
	qry = " BEGIN"
	qry = qry + " PKG_RPT_STOCKLIBCONTROLADOS.PRO_RPT_STOCKLIBCONTROLADOS("
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package reporte stock libro controlados",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package reporte stock libro controlados",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	...
	sReporte = "stocklibcontrolados.rpt"
