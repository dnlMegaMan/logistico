...
func PeriodosGenerarAjusteInventarios(w http.ResponseWriter, r *http.Request) {
	...
	QUERY := "BEGIN PCK_FILTRO_GENERAR_AJUSTE_INVENTARIO.P_PERIODOS_INVEN_BODEGAS(:1,:2,:3); END;"
