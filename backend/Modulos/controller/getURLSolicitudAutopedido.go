...
// GetURLSolicitudAutopedido is...
func GetURLSolicitudAutopedido(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfSolicitudAutopedido
	...
	res := models.ParamInfSolicitudAutopedido{}
	...
	var qry string
	qry = " BEGIN"
	qry = qry + " PKG_RPT_SOLICITUDAUTOPEDIDO.PRO_RPT_SOLICITUDAUTOPEDIDO("
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package reporte solicitud autopedido",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package reporte solicitud autopedido",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	...
	sReporte = "adminsolicautoped.rpt"
