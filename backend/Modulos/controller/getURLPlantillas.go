...
// GetURLPlantillas is...
func GetURLPlantillas(w http.ResponseWriter, r *http.Request) {
	...
	var qry string
	qry = " BEGIN"
	qry = qry + " PKG_RPT_PLANTILLA.PRO_RPT_PLANTILLA("
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package reporte plantilla",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package reporte plantilla",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
