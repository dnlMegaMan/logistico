...
// ObtieneURLinfConsumoBodegaValo is...
func ObtieneURLinfConsumoBodegaValo(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfConsumoBodegaValo
	...
	res := models.ParamInfConsumoBodegaValo{}
	...
	sReporte = "logistico/rpt_consumo_x_bodega_valo.rpt"
	sTipo = PTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe consumo bodega valo",
		Contexto: map[string]interface{}{
