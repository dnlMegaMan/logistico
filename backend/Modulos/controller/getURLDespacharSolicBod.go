...
func GetURLDespacharSolicBod(w http.ResponseWriter, r *http.Request) {
	...
	var qry string
	qry = " BEGIN"
	qry = qry + " PKG_RPT_DESPACHARSOLICBOD.PRO_RPT_DESPACHARSOLICBOD("
	...
	sReporte = "despacharsolicbod.rpt"
