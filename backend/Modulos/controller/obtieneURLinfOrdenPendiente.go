...
// ObtieneURLinfOrdenPendiente is...
func ObtieneURLinfOrdenPendiente(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfOrdenPendiente
	...
	res := models.ParamInfOrdenPendiente{}
	...
	_, err = db.Exec("Begin PKG_RPT_OC_ITEM_PENDIENTES.PRO_RPT_OC_ITEM_PENDIENTES(:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo); end;", intIDReport, PHdgCodigo, PEsaCodigo, PCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_OC_ITEM_PENDIENTES.PRO_RPT_OC_ITEM_PENDIENTES",
			Error:   err,
	...
	sReporte = "logistico/rpt_oc_pendiente.rpt"
	sTipo = PTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe orden pendiente",
		Contexto: map[string]interface{}{
