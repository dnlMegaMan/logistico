...
func FiltroInformeListaConteoInventario(w http.ResponseWriter, r *http.Request) {
	...
	PKG := "PCK_LISTADO_PARA_REALIZAR_INVENTARIO"
	QUERY := "BEGIN PCK_LISTADO_PARA_REALIZAR_INVENTARIO.P_LISTADO_PARA_REALIZAR_INVENTARIO(:1,:2,:3); END;"
