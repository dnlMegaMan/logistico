...
// GetURLRecepcionarSolicBod is...
func GetURLRecepcionarSolicBod(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfAdminSolicBod
	...
	res := models.ParamInfAdminSolicBod{}
	...
	var qry string
	qry = " BEGIN"
	qry = qry + " PKG_RPT_RECEPCIONARSOLICBOD.PRO_RPT_RECEPCIONARSOLICBOD("
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package reporte recepcionar solicitud bodega",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package reporte recepcionar solicitud bodega",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	...
	sReporte = "recepcionarsolicbod.rpt"
