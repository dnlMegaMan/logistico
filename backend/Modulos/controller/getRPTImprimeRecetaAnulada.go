...
// GetRPTImprimeRecetaAnulada is...
func GetRPTImprimeRecetaAnulada(w http.ResponseWriter, r *http.Request) {
	...
	logger.Trace(logs.InformacionLog{
		Query:   qry,
		Mensaje: "Query package get reporte imprime receta anulada",
	})

	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query package get reporte imprime receta anulada",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
