...
func CrearNuevoAjusteInventario(w http.ResponseWriter, r *http.Request) {
	...
	var requestMessage models.EstructuraCrearAjusteInvenario
	...
	QUERY := "BEGIN PCK_FARM_INVENTARIOS.P_AJUSTE_INV_MAN(:1,:2,:3); END;"
