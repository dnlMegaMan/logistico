...
// PeriodosInventarios is...
func PeriodosInventarios(w http.ResponseWriter, r *http.Request) {
	...
	QUERY := "BEGIN PCK_FARM_INVENTARIOS.P_PERIODOS_INVEN_BODEGAS(:1,:2,:3); END;"
