...
// ObtieneURLinfTendenciaConsumo is...
func ObtieneURLinfTendenciaConsumo(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfTendenciaConsumo
	...
	res := models.ParamInfTendenciaConsumo{}
	...
	qry = " BEGIN"
	qry = qry + " PKG_RPT_TENDENCIAS.PRO_RPT_TENDENCIAS("
	...
	if err != nil {
		logger.Error(logs.InformacionLog{
			Query:   qry,
			Mensaje: "Se cayo query informe tendencia consumo",
			Error:   err,
		})
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
