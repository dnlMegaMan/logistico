...
// ObtieneURLinfReposicionBodegas is...
func ObtieneURLinfReposicionBodegas(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfRepocisionBodegas
	...
	res := models.ParamInfRepocisionBodegas{}
	...
	_, err = db.Exec("Begin PKG_RPT_REPOSICION_AUT.PRO_RPT_REPOSICION_AUT(:In_Id_Repo,:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo ); end;", pIDRepo, intIDReport, pHdgCodigo, pEsaCodigo, pCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_REPOSICION_AUT.PRO_RPT_REPOSICION_AUT",
			Error:   err,
			Contexto: map[string]interface{}{
				"pIDRepo": pIDRepo, "intIDReport": intIDReport, "pHdgCodigo": pHdgCodigo,
	...
	sReporte = "logistico/rpt_informe_reposicion_bodegas.rpt"
	sTipo = pTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe reposicion bodegas",
		Contexto: map[string]interface{}{
