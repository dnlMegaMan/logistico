...
// GetURLReporteConteoManualInventario is...
func GetURLReporteConteoManualInventario(w http.ResponseWriter, r *http.Request) {
	...
	var requestMessage models.ParamReporteConteoManualInventario
	...
	QUERY := "BEGIN PKG_RPT_LISTADO_ALFA_PRODUCTOS.PRO_RPT_LISTADO_CONTEO_INVENTARIO(:1,:2,:3); END;"
	...
	// Genera la URL
	sReporte = "rpt_lista_conteo_manual_inventario.rpt"
