...
// WsLogIntegraPedidoFunc is...
func WsLogIntegraPedidoFunc(res models.LogIntegraPedidoFin700) (models.RespuestaIntegracion, error) {
	...
	if errURL != nil {
		...
		return models.RespuestaIntegracion{}, errURL
	}
	defer rowsURL.Close()
	...
	if err != nil {
		...
		return models.RespuestaIntegracion{}, err
	}
	defer rows.Close()
	...
	if rows != nil {
		...
		for rows.Next() {
			...
			xmlLlamada.GetBody.GetwmIntegraPedido.GetOperacionIntegraPedido.GetDetallePedido.GetLineaDetalle = append(xmlLlamada.GetBody.GetwmIntegraPedido.GetOperacionIntegraPedido.GetDetallePedido.GetLineaDetalle, xmlLineaPedido)
		}
		...
		case "SOL":
			if resultado.NumeroPedido > 0 {
				...
				if errUpdate != nil {
					...
					return models.RespuestaIntegracion{}, errUpdate
				}
		...
		valores.FOLIO = resultado.NumeroPedido
	}
