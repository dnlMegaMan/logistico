...
// ObtieneURLinfOrdenCompraCerradaMan is...
func ObtieneURLinfOrdenCompraCerradaMan(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfOrdenCompraCerradaMan
	...
	res := models.ParamInfOrdenCompraCerradaMan{}
	...
	_, err = db.Exec("Begin PKG_RPT_CLIN_OC_CERRADAS_MAN.PRO_RPT_CLIN_OC_CERRADAS_MAN(:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo); end;", intIDReport, PHdgCodigo, PEsaCodigo, PCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_CLIN_OC_CERRADAS_MAN.PRO_RPT_CLIN_OC_CERRADAS_MAN",
			Error:   err,
	...
	sReporte = "logistico/rpt_oc_cerradas.rpt"
	sTipo = PTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe orden compra cerrada man",
		Contexto: map[string]interface{}{
