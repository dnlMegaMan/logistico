...
// ObtieneURLinfPreciosProductos is...
func ObtieneURLinfPreciosProductos(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfPreciosProductos
	...
	res := models.ParamInfPreciosProductos{}
	...
	_, err = db.Exec("Begin PKG_RPT_LISTADO_PRECIOS.PRO_RPT_LISTADO_PRECIOS(:In_Codigo_Far,:In_Tipo_Reg,:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo ); end;", pCodigoFar, pTipoReg, intIDReport, pHdgCodigo, pEsaCodigo, pCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_LISTADO_PRECIOS.PRO_RPT_LISTADO_PRECIOS",
			Error:   err,
			Contexto: map[string]interface{}{
				"pCodigoFar": pCodigoFar, "pTipoReg": pTipoReg, "intIDReport": intIDReport,
	...
	sReporte = "logistico/rpt_listado_de_precios.rpt"
	//sTipo     = "pdf"
	sTipo = pTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe precios productos",
		Contexto: map[string]interface{}{
