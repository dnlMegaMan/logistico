...
// ObtieneURLinfDetalleOrdenCompra is...
func ObtieneURLinfDetalleOrdenCompra(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfDetalleOrdenCompra
	...
	res := models.ParamInfDetalleOrdenCompra{}
	...
	_, err = db.Exec("Begin PKG_RPT_DET_ORDENES_DE_COMPRA.PRO_RPT_DET_ORDENES_DE_COMPRA(:In_TipoMed,:In_Fecha_Ini,:In_Fecha_Fin,:In_IdReport,:In_HdgCodigo,:In_EsaCodigo,:In_CmeCodigo); end;", PTipoMed, PFechaini, PFechafin, intIDReport, PHdgCodigo, PEsaCodigo, PCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_DET_ORDENES_DE_COMPRA.PRO_RPT_DET_ORDENES_DE_COMPRA",
			Error:   err,
			Contexto: map[string]interface{}{
				"PTipoMed": PTipoMed, "PFechaini": PFechaini, "PFechafin": PFechafin,
	...
	sReporte = "logistico/inf_det_ordenes_compras.rpt"
	sTipo = PTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe detalle orden compra",
		Contexto: map[string]interface{}{
