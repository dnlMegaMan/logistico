...
// ObtieneURLinfBodegasValorizadas is...
func ObtieneURLinfBodegasValorizadas(w http.ResponseWriter, r *http.Request) {
	...
	// Unmarshal
	var msg models.ParamInfBodegasValorizadas
	...
	res := models.ParamInfBodegasValorizadas{}
	...
	_, err = db.Exec("Begin PKG_RPT_BODEGAS_VALORIZADA.PRO_RPT_BODEGAS_VALORIZADA(:In_Codigo_Bod,:In_Tipo_Reg,:In_IdReport,:In_Hdgcodigo,:In_Esacodigo,:In_Cmecodigo ); end;", pCodigoBod, pTipoReg, intIDReport, pHdgCodigo, pEsaCodigo, pCmeCodigo)

	if err != nil {
		logger.Error(logs.InformacionLog{
			Mensaje: "Se cayo query al ejecutar pkg PKG_RPT_BODEGAS_VALORIZADA.PRO_RPT_BODEGAS_VALORIZADA",
			Error:   err,
			Contexto: map[string]interface{}{
				"pCodigoBod": pCodigoBod, "pTipoReg": pTipoReg, "intIDReport": intIDReport,
	...
	sReporte = "logistico/rpt_bodegas_valorizadas.rpt"
	sTipo = pTipoReport
	...
	logger.Trace(logs.InformacionLog{
		Mensaje: "Datos informe bodegas valorizadas",
		Contexto: map[string]interface{}{
