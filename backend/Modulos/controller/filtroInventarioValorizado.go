...
func FiltroInventarioValorizado(w http.ResponseWriter, r *http.Request) {
	...
	var requestMessage models.EstructuraGenerarInventarioSistemas
	...
	PKG := "PCK_FILTRO_INVENTARIO_VALORIZADO"
	QUERY := "BEGIN PCK_FILTRO_INVENTARIO_VALORIZADO.P_FILTRO_INVENTARIO_VALORIZADO(:1,:2,:3); END;"
